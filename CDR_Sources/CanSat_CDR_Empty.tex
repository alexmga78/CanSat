...
\centering
\caption{Power sourcing diagram}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=15cm]{Schema_electrica2}
\centering
\caption{Sensors connectivity diagram}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=15cm]{Schema_electrica3}
\centering
\caption{Modules connectivity diagram}
\end{figure}

\item \textbf{RF Link:} Communication is established via radio frequency (RF) links, comprising a transmitter and receiver. The downlink transmits telemetry data from the CanSat to ground stations, while the uplink allows for remote commands and control. The data rate and protocol of the RF link are carefully selected to ensure reliable communication within the constraints of the mission.
