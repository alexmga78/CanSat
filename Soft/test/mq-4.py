...
# Test script
def main():
    mq4 = MQ4(board.A0)  # Assuming MQ-4 sensor is connected to A0 pin
    try:
        while True:
            raw_value = mq4.read_raw_value()
            voltage = mq4.read_voltage()
            gas_concentration = mq4.read_gas_concentration()
